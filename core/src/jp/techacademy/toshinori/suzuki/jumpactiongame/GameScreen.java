...
public class GameScreen extends ScreenAdapter {
    ...
    Sound hitSound = Gdx.audio.newSound(Gdx.files.internal("data/middle_punch2.mp3"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.toshinori.suzuki.jumpactiongame");
